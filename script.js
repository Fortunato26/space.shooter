...
//funcao movimento e tiro da nave
...
//Tempo que o laser vai demorar pra chegar até o final
...
//funcao para criar inimigos aleatórios
...
function moveAlien(alien) {
    let moveAlienInterval = setInterval(() => {
        ...
        if (xPostion <= 50) {
            ...
            alien.style.left = `${xPostion - 5}px`;
        }
    }, 30);
}
